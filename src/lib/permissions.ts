...
export type Role = 'admin' | 'manager' | 'operator' | 'employee';
...
export const ROLE_PERMISSIONS: Record<Role, RolePermissions> = {
  ...
  manager: {
    // Manager = alles außer User löschen & Rollen ändern
    ...
    can_manage_products: true, // darf Produkte anlegen/bearbeiten
    can_adjust_stock: true, // darf Bestand ändern
    can_delete_products: false // ❌ keine Produkte löschen
  },
  operator: {
    // Operator = Lager & Produkte pflegen, aber kein User-Management
  ...
  employee: {
    // Employee = nur Lagerbewegungen (Add/Remove), keine Produktpflege
    can_access_admin_panel: false,
    can_manage_users: false,
    can_delete_users: false,
    can_manage_products: false, // ❌ keine neuen Produkte / Edit
    can_adjust_stock: true, // ✅ darf ein- und ausbuchen
    can_delete_products: false
  }
};

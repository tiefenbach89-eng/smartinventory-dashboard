    ...
    <>
      <Card className='flex h-full flex-col border-0'>
        <CardHeader className='border-b border-border/10 pb-6'>
          ...
          <CardDescription className='font-semibold'>{t('description')}</CardDescription>
        </CardHeader>
            ...
            <>
              ...
              <div className='space-y-3'>
                <div className='flex items-center justify-between'>
                  <h3 className='flex items-center gap-2 text-sm font-black uppercase tracking-wider text-emerald-600'>
